...
cd /tf/avm/gcc_starter_kit/landingzone/configuration/2-solution_accelerators/devops/containter_instance_avm
...
-backend-config="key=solution_accelerators-devops-container-instance-avm.tfstate"
