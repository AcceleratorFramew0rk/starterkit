...
module "application_gateway" {
  ...
  gateway_ip_configuration  = {  
    gateway_ip_configuration1  = {
      ...
      subnet_id = try(local.remote.networking.virtual_networks.hub_intranet_ingress.virtual_subnets.subnets["AgwSubnet"].id, null) != null ? local.remote.networking.virtual_networks.hub_intranet_ingress.virtual_subnets.subnets["AgwSubnet"].id : var.subnet_id 
    }
  }
  frontend_port  = {  
    80  = {
