...
AZUREFIREWALLMANAGEMENT_SUBNET_NAME="AzureFirewallManagementSubnet"
...
SUBNET_ID="/subscriptions/${SUBSCRIPTION_ID}/resourceGroups/gcci-platform/providers/Microsoft.Network/virtualNetworks/${VNET_NAME}/subnets/${AZUREFIREWALLMANAGEMENT_SUBNET_NAME}"
...
-backend-config="key=solution_accelerators-management-bastion.tfstate"
...
-var="azurefirewallmanagement_subnet_id=${AZUREFIREWALLMANAGEMENT_SUBNET_ID}" \
