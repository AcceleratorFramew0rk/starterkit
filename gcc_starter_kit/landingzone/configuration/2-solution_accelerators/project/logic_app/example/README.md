# ------------------------------------------------------------------
# Standalone deployment - app service
# ------------------------------------------------------------------
...
SERVICE_SUBNET_NAME="ServiceSubnet"
...
SERVICE_SUBNET_ID="/subscriptions/${SUBSCRIPTION_ID}/resourceGroups/gcci-platform/providers/Microsoft.Network/virtualNetworks/${VNET_NAME}/subnets/${SERVICE_SUBNET_NAME}"
