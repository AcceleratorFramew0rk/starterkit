...
terraform init  -reconfigure \
-backend-config="resource_group_name=wms99dev-rg-launchpad" \
-backend-config="storage_account_name=wms99devstgtfstatelrr" \
-backend-config="container_name=2-solution-accelerators" \
-backend-config="key=solution_accelerators-project-containerinstance.tfstate"

terraform plan \
-var="storage_account_name=wms99devstgtfstatelrr" \
-var="resource_group_name=wms99dev-rg-launchpad"
