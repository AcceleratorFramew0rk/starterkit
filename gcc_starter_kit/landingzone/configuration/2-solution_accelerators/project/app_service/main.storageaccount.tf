...
#   location                      = azurerm_resource_group.this.location
#   name                          = "${module.naming.storage_account.name_unique}backup${random_string.this.result}"
#   resource_group_name           = azurerm_resource_group.this.name
...
#       private_dns_zone_resource_ids = [module.private_dns_zones1.resource.id] 
