...
cd /tf/avm/gcc_starter_kit/landingzone/configuration/2-solution_accelerators/project/notification_hub
...
-backend-config="key=solution_accelerators-project-notificationhub.tfstate"
